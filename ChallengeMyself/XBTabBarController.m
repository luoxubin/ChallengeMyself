...
- (id)initWithViewControllers:(NSArray *)vcs btnInfoArray:(NSArray *)arr;
{
	self = [super init];
	if (self != nil)
	{
		...
		_tabBar = [[XBTabBar alloc] initWithFrame:CGRectMake(0, _containerView.frame.size.height - kTabBarHeight, 320.0f, kTabBarHeight) buttonInfos:arr];
