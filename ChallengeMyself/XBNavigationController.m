...
- (void)loadView
{
	...
	if ([Utility iOS5Simida]) {
		[self.navigationController.navigationBar setBackgroundImage:PNGImage2x(@"navigationbar_bg")
	...
	// 导航栏下方阴影
	if (!navShadow) {
		navShadow = [[UIImageView alloc] initWithImage:PNGImage2x(@"navigationbar_shadow")];
